                            ...
                            {mangDanhMuc.map((danhMuc, index) => {
                                ...
                                return <li className="bg-coolGray-100 text-coolGray-900" key={index} onClick={() => {
                                    ...
                                    <a href="#" className={classNameActive.join(' ')}>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fillCurrent text-coolGray-600">
                                ...
                                {_.filter(data, item => item.maDanhMuc === maDanhMuc).map((item, index) => {
                                    return <div className="p-4 lg:w-1/3" key={index}>
                                        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                            ...
                                            <div className="text-center mt-2 leading-none flex justify-end absolute bottom-0 left-0 w-full py-4">
                                                <span className="text-gray-400 mr-3 inline-flex items-center leading-none pr-3 py-1 border-gray-200 text-xl">
                                                    Giá: {item.gia}
                                                </span>
                                            </div>
                                        </div>
